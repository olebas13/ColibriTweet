...
public class TweetAdapter extends RecyclerView.Adapter<TweetAdapter.TweetViewHolder> {
    ...
    class TweetViewHolder extends RecyclerView.ViewHolder {
        ...
        public TweetViewHolder(View itemView) {
            ...
            contentTextView = (TextView) itemView.findViewById(R.id.tweet_content_text_view);
            tweetImageView = (ImageView) itemView.findViewById(R.id.tweet_image_view);
            retweetsTextView = (TextView) itemView.findViewById(R.id.retweets_text_view);
        ...
        public void bind(Tweet tweet) {
            ...
            Picasso.get().load(tweet.getUser().getImgUrl()).into(userImageView);

            String tweetPhotoUrl = tweet.getImgUrl();
